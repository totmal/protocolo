...
@csrf
		<div class="row form-group" >
			...
			<div class="col-3 border pl-4 pr-4 p-1">
				...
				<div id="abas">
					<input type="text" name="cpfcnpj" placeholder="CPF/CNPJ" id="cpfcnpj" class="form-control" onclick="myFunction2()" >
		...
		<div class="row form-group" style="height: 100px;">
			...
			<div class="col-3 border pl-4 pr-4 p-1">
				...
				<input  name="codigo_entrada" type="text" class="form-control" placeholder="FalaBr/SisOuvidor... ">
			</div>			
			...
			<div class="col-3 border pl-4 pr-4 p-1">
				...
				<input required="true" name="resp_cadastro" type="text"	class="form-control text-uppercase" value="{{auth() -> user() -> name}}" placeholder="">
			</div>
		</div>
