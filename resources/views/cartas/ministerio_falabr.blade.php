		...
		<div class="content-inside">
			...
			<br /><br />
				...
				<p class="text-justify">
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Informamos que a carta encaminhada à Ouvidoria do Ministério da Economia foi cadastrada em nosso sistema com o número de protocolo <?php echo "$codigo_entrada"; ?>, e será levada ao conhecimento da área responsável para análise dos fatos. <br />
