	...
	<div class="" style="font-family: Times New Roman;">
			...
			<br /><br />
				...
				<p class="text-justify">
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Acusamos o recebimento de sua carta. No entanto, identificamos outra manifestação, cadastrada em nosso sistema com o número de protocolo <?php echo "$codigo_entrada"; ?>, tratando do mesmo assunto. <br /> <br />
