		...
		<div class="content-inside">
			...
			<br /><br />
				...
				<p class="text-justify">
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Informamos que a carta encaminhada à Ouvidoria do Ministério da Economia foi cadastrada em nosso sistema com o número de protocolo {{$equipamento->codigo_entrada}}, e será levada ao conhecimento da área responsável para análise dos fatos. <br />
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;A resposta final da manifestação poderá ser consultada, mediante o fornecimento do número da manifestação e do código de acesso, por meio do seguinte link: <br />
				...
				<p class="text-justify">
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Por oportuno, sugerimos que caso seja de seu interesse, para futuras manifestações, utilize o FalaBr - Plataforma que permite aos cidadãos fazer pedidos de informações públicas e manifestações de ouvidoria, em conformidade com a Lei de  <br />
					Acesso à Informação e o Código de Defesa dos Usuários de Serviços Público diretamente na internet.  <br />
